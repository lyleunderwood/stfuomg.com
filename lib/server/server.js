(function() {
  var Message, app, connect, create_color, create_session_token, formidable, io, redis, redis_client, sio, upload_file, upload_middleware, util;
  ...
  app = connect().use(connect.logger('dev')).use(upload_middleware).use(connect.static('lib/client')).listen(3001);
