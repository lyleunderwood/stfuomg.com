...
(function() {
  ...
  app = connect().use(connect.logger('dev')).use(upload_middleware).use(connect["static"](__dirname + '/../client', {
    maxAge: two_days
    ...
    return io.sockets.on('connection', function(socket) {
      ...
      socket.on('message', function(data) {
        ...
        if (!(data.content != null) || (data.content.match(/^[ \t\n]*$/) !== null)) {
          return;
        }
        ...
        message.save(function(error, id) {
          ...
          return process.nextTick(function() {
            ...
            return Message.prune(function(error, images_to_delete) {
              ...
              pruning = false;
              if (error) {
                return console.log('failed to prune', error);
              }
              if (!images_to_delete) {
                return null;
              }
  ...
  create_session_token = function() {
    var bit, chars, ret, _i;
    chars = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/';
    ret = '';
    for (bit = _i = 24; _i > 0; bit = --_i) {
