(function() {
  var App, EntryForm, ImageMedia, Media, Message, MessageList, Node, Upload, YoutubeMedia, global;
  ...
  Upload = (function() {
    ...
    Upload.prototype.attach_events = function() {
      ...
      return this.cancel_btn.addEventListener('click', function(e) {
        return _this.clear();
      });
    };
    ...
    Upload.prototype.set_selected_file = function(file) {
      ...
      return this.size_node.innerHTML = file.size;
    };
    ...
    Upload.prototype.upload = function() {
      ...
      xhr.upload.addEventListener('progress', function(e) {
        return console.log('progress', e);
      });
      xhr.addEventListener('load', function(e) {
        console.log('load', e);
        _this.completed.dispatch();
        return _this.clear();
      });
    ...
    Upload.supported = function() {
      ...
      return !!(FileList && FileReader && FormData && (new XMLHttpRequest).upload);
    };
  ...
  EntryForm = (function() {
    ...
    EntryForm.prototype.build = function() {
      ...
      if (Upload.supported()) {
        ...
        this.uploader = new Upload(document.body);
    ...
    EntryForm.prototype.attach_events = function() {
      ...
      if (this.uploader) {
        ...
        return this.uploader.cleared.add(function() {
    ...
    EntryForm.prototype.submit_message = function() {
      var has_upload_file, text, valid;
      var _this = this;
    ...
    EntryForm.prototype.perform_submit = function() {
      this.message_submitted.dispatch(this.message_input.value);
