(function() {
  ...
  Upload = (function() {
    ...
    Upload.prototype.build = function() {
      ...
      this.progress_bar.appendChild(this.bar);
    ...
    Upload.prototype.attach_events = function() {
      ...
      this.socket.on('upload_started', function() {
        return _this.start();
      });
      return this.socket.on('upload_progress', function(e) {
        return _this.bar.style.width = e.percent + '%';
      });
    };
  ...
  MessageList = (function() {
    ...
    MessageList.prototype.attach_events = function() {
      ...
      return this.filter_pane.changed.add(this.filters_set);
    };
  ...
  Message = (function() {
    ...
    Message.prototype.show = function() {
      return this.node.style.display = 'table-row';
    };
    ...
    Message.prototype.filter = function(filters) {
      ...
      if (!filters.show_joinpart && this.is_joinpart()) return this.hide();
      if (filters.mediaonly && !this.has_media()) return this.hide();
      if (filters.keywords) {
