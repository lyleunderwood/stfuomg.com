(function() {
    ...
    require.paths = [], require.modules = {}, require.cache = {}, require.extensions = [ ".js", ".coffee", ".json" ], require._core = {
        ...
        t.exports = f;
        var u = 0;
    }), require.define("/node_modules/jsonp/node_modules/debug/package.json", function(e, t, n, r, i, s) {
        t.exports = {
            main: "lib/debug.js",
            browserify: "debug.js"
        };
    }), require.define("/node_modules/jsonp/node_modules/debug/debug.js", function(e, t, n, r, i, s) {
        function o(e) {
        ...
        (function() {
            ...
            c = function() {
                ...
                return e.prototype.build = function() {
                    var e, t, n, r, i, s, o, u;
                    return this.node = document.createElement("div"), this.node.id = "filter_pane", e = document.createElement("fieldset"), this.node.appendChild(e), s = document.createElement("legend"), s.innerHTML = "Filters", e.appendChild(s), r = document.createElement("div"), r.className = "field keyword", e.appendChild(r), i = document.createElement("label"), i.innerHTML = "Keyword", i["for"] = "keyword", r.appendChild(i), this.keyword = document.createElement("input"), this.keyword.id = "keyword", this.keyword.type = "text", r.appendChild(this.keyword), t = document.createElement("div"), t.className = "field show_joinpart", e.appendChild(t), n = document.createElement("label"), n.innerHTML = "Show join / part messages", n["for"] = "show_joinpart", t.appendChild(n), this.show_joinpart = document.createElement("input"), this.show_joinpart.id = "show_joinpart", this.show_joinpart.value = !0, this.show_joinpart.checked = !1, this.show_joinpart.type = "checkbox", t.appendChild(this.show_joinpart), o = document.createElement("div"), o.className = "field mediaonly", e.appendChild(o), u = document.createElement("label"), u.innerHTML = "With Media Only", u["for"] = "mediaonly", o.appendChild(u), this.mediaonly = document.createElement("input"), this.mediaonly.id = "mediaonly", this.mediaonly.value = !0, this.mediaonly.checked = !1, this.mediaonly.type = "checkbox", o.appendChild(this.mediaonly);
                ...
                return T(t, e), t.prototype.window_focused = null, t.prototype.build = function() {
                    ...
                    var t;
                    e.user_name = this.options.name, e = new f(e), this.messages[this.messages.length] = e, t = this.at_bottom(), this.list_node.appendChild(e.build()), e.filter(this.filter_pane.get_filters());
                    if (t) return this.scroll_bottom();
                ...
                }, t.prototype.at_bottom = function() {
                    ...
                    return setTimeout(function() {
                        var n, r, i, s;
                        e.show_joinpart ? t.add_class("show_joinpart") : t.remove_class("show_joinpart"), e.mediaonly ? t.add_class("mediaonly") : t.remove_class("mediaonly"), s = t.messages;
