(function() {
    var require = function(e, t) {
        var n = require.resolve(e, t || "/"), r = require.modules[n];
        if (!r) throw new Error("Failed to resolve module " + e + ", tried " + n);
        var i = require.cache[n], s = i ? i.exports : r();
        return s;
    };
    require.paths = [], require.modules = {}, require.cache = {}, require.extensions = [ ".js", ".coffee", ".json" ], require._core = {
        ...
        return function(e, t) {
            function o(e) {
                ...
                for (var t = 0; t < require.extensions.length; t++) {
                    var r = require.extensions[t];
                    if (require.modules[e + r]) return e + r;
                }
            }
            function u(e) {
                e = e.replace(/\/+$/, "");
                var t = n.normalize(e + "/package.json");
                if (require.modules[t]) {
                    var r = require.modules[t](), i = r.browserify;
        ...
        var n = require.modules.path(), r = null;
        try {
            r = require.resolve(e + "/package.json", "/");
        } catch (i) {
            r = require.resolve(e, "/");
        }
        var s = n.dirname(r), o = (Object.keys || function(e) {
            var t = [];
        ...
        var e = {};
        require.define = function(t, n) {
            require.modules.__browserify_process && (e = require.modules.__browserify_process());
            var r = require._core[t] ? "" : require.modules.path().dirname(t), i = function(e) {
                var t = require(e, r), n = require.cache[require.resolve(e, r)];
                return n && n.parent === null && (n.parent = s), t;
            };
            i.resolve = function(e) {
                return require.resolve(e, r);
            }, i.modules = require.modules, i.define = require.define, i.cache = require.cache;
            var s = {
                id: t,
                filename: t,
                exports: {},
            ...
            require.modules[t] = function() {
                return require.cache[t] = s, n.call(s.exports, i, s, s.exports, r, t, e), s.loaded = !0, s.exports;
            };
        };
    }(), require.define("path", function(e, t, n, r, i, s) {
        function o(e, t) {
            var n = [];
        ...
        s.nextTick = function() {
            ...
            if (t) {
                ...
                return window.addEventListener("message", function(e) {
                    ...
                    n.push(t), window.postMessage("browserify-tick", "*");
                };
            }
            return function(t) {
                setTimeout(t, 0);
    ...
    }), require.define("/node_modules/signals/package.json", function(e, t, n, r, i, s) {
        t.exports = {
            main: "dist/signals.js"
        };
    }), require.define("/node_modules/signals/dist/signals.js", function(e, t, n, r, i, s) {
        (function(e) {
            ...
            n.prototype = {
                ...
                _registerListener: function(e, t, r, i) {
                    var s = this._indexOfListener(e, r), o;
                    if (s !== -1) {
                        o = this._bindings[s];
            ...
            var s = i;
            s.Signal = i, typeof define == "function" && define.amd ? define(function() {
                return s;
            }) : typeof t != "undefined" && t.exports ? t.exports = s : e.signals = s;
        })(this);
    }), require.define("/node_modules/jsonp/package.json", function(e, t, n, r, i, s) {
        t.exports = {};
    }), require.define("/node_modules/jsonp/index.js", function(e, t, n, r, i, s) {
        function a() {}
        function f(e, t, n) {
            function p() {
                f.parentNode.removeChild(l), window["__jp" + h] = a;
            }
            "function" == typeof t && (n = t, t = {});
            var t = t || {}, r = t.param || "callback", i = null != t.timeout ? t.timeout : 6e4, s = encodeURIComponent, f = document.getElementsByTagName("script")[0], l, c, h = u++;
            i && (c = setTimeout(function() {
                p(), n && n(new Error("Timeout"));
            }, i)), window["__jp" + h] = function(e) {
                o("jsonp got", e), c && clearTimeout(c), p(), n && n(null, e);
            }, e += (~e.indexOf("?") ? "&" : "?") + r + "=" + s("__jp" + h + ""), e = e.replace("?&", "?"), o('jsonp req "%s"', e), l = document.createElement("script"), l.src = e, f.parentNode.insertBefore(l, f);
        }
        var o = e("debug")("jsonp");
        t.exports = f;
        var u = 0;
    }), require.define("/node_modules/debug/package.json", function(e, t, n, r, i, s) {
        t.exports = {
            main: "lib/debug.js",
            browserify: "debug.js"
        };
    }), require.define("/node_modules/debug/debug.js", function(e, t, n, r, i, s) {
        function o(e) {
            return o.enabled(e) ? function(t) {
                var n = new Date, r = n - (o[e] || n);
                o[e] = n, t = e + " " + t + " +" + o.humanize(r), window.console && console.log && Function.prototype.apply.call(console.log, console, arguments);
            } : function() {};
        }
        t.exports = o, o.names = [], o.skips = [], o.enable = function(e) {
            try {
                localStorage.debug = e;
            } catch (t) {}
            var n = (e || "").split(/[\s,]+/), r = n.length;
            for (var i = 0; i < r; i++) e = n[i].replace("*", ".*?"), e[0] === "-" ? o.skips.push(new RegExp("^" + e.substr(1) + "$")) : o.names.push(new RegExp("^" + e + "$"));
        }, o.disable = function() {
            o.enable("");
            ...
            for (var t = 0, n = o.skips.length; t < n; t++) if (o.skips[t].test(e)) return !1;
            for (var t = 0, n = o.names.length; t < n; t++) if (o.names[t].test(e)) return !0;
            return !1;
        }, window.localStorage && o.enable(localStorage.debug);
    }), require.define("/node_modules/dlite-jsonp/package.json", function(e, t, n, r, i, s) {
        t.exports = {
            main: "index.js"
        };
    }), require.define("/node_modules/dlite-jsonp/index.js", function(e, t, n, r, i, s) {
        t.exports = function(e, t) {
            var n = "j" + (Math.random() * (1 << 30)).toString(16).replace(".", ""), r = document.createElement("script");
            window._jsonp_callbacks[n] = function(e) {
                t && t(e), delete window._jsonp_callbacks[n], r.parentNode.removeChild(r);
            }, r.src = e.replace("callback=%3F", "callback=_jsonp_callbacks." + n), document.getElementsByTagName("head")[0].appendChild(r);
        }, window._jsonp_callbacks = {};
    }), require.define("/node_modules/store/package.json", function(e, t, n, r, i, s) {
        t.exports = {
            main: "store"
        };
    }), require.define("/node_modules/store/store.js", function(e, t, n, r, i, s) {
        (function() {
            function a() {
                try {
                    return i in n && n[i];
            ...
            var e = {}, n = window, r = n.document, i = "localStorage", s = "globalStorage", o = "__storejs__", u;
            ...
            if (a()) u = n[i], e.set = function(t, n) {
                if (n === undefined) return e.remove(t);
                u.setItem(t, e.serialize(n));
            }, e.get = function(t) {
                ...
                return t;
            }; else if (f()) u = n[s][n.location.hostname], e.set = function(t, n) {
                if (n === undefined) return e.remove(t);
                u[t] = e.serialize(n);
            }, e.get = function(t) {
                ...
                var l, c;
                try {
                    c = new ActiveXObject("htmlfile"), c.open(), c.write('<script>document.w=window</script><iframe src="/favicon.ico"></frame>'), c.close(), l = c.w.frames[0].document, u = l.createElement("div");
                } catch (h) {
                ...
                e.set = p(function(t, n, r) {
                    n = d(n);
                    if (r === undefined) return e.remove(n);
                    t.setAttribute(n, e.serialize(r)), t.save(i);
                }), e.get = p(function(t, n) {
                    return n = d(n), e.deserialize(t.getAttribute(n));
                }), e.remove = p(function(e, t) {
                    t = d(t), e.removeAttribute(t), e.save(i);
            ...
            typeof t != "undefined" ? t.exports = e : typeof define == "function" && define.amd ? define(e) : this.store = e;
        })();
    }), require.define("/node_modules/socket.io-client/package.json", function(e, t, n, r, i, s) {
        t.exports = {
            main: "./lib/io.js",
            browserify: "./dist/socket.io.js"
        };
    }), require.define("/node_modules/socket.io-client/dist/socket.io.js", function(require, module, exports, __dirname, __filename, process) {
    ...
    }), require.define("/node_modules/tinycon/package.json", function(e, t, n, r, i, s) {
        t.exports = {};
    }), require.define("/node_modules/tinycon/tinycon.js", function(e, t, n, r, i, s) {
        (function() {
            var e = {}, n = null, r = null, i = document.title, s = null, o = null, u = {}, a = {
                width: 7,
                height: 9,
                font: "10px arial",
                colour: "#ffffff",
                ...
                if (!r || !n) {
                    var e = c();
                    r = n = e ? e.getAttribute("href") : "/favicon.ico";
                }
                return n;
            }, d = function() {
                ...
                if (!d().getContext || l.ie || l.safari || u.fallback === "force") return y(e);
                var n = d().getContext("2d"), t = t || "#000000", e = e || 0, r = p();
                s = new Image, s.onload = function() {
                    n.clearRect(0, 0, 16, 16), n.drawImage(s, 0, 0, s.width, s.height, 0, 0, 16, 16), e > 0 && b(n, e, t), w();
                }, r.match(/^data/) || (s.crossOrigin = "anonymous"), s.src = r;
            }, y = function(e) {
                u.fallback && (e > 0 ? document.title = "(" + e + ") " + i : document.title = i);
            }, b = function(e, t, n) {
                var r = (t + "").length - 1, i = u.width + 6 * r, s = 16 - i, o = 16 - u.height;
                e.font = (l.webkit ? "bold " : "") + u.font, e.fillStyle = u.background, e.strokeStyle = u.background, e.lineWidth = 1, e.fillRect(s, o, i - 1, u.height), e.beginPath(), e.moveTo(s - .5, o + 1), e.lineTo(s - .5, 15), e.stroke(), e.beginPath(), e.moveTo(15.5, o + 1), e.lineTo(15.5, 15), e.stroke(), e.beginPath(), e.strokeStyle = "rgba(0,0,0,0.3)", e.moveTo(s, 16), e.lineTo(15, 16), e.stroke(), e.fillStyle = u.colour, e.textAlign = "right", e.textBaseline = "top", e.fillText(t, 15, l.mozilla ? 7 : 6);
            }, w = function() {
            ...
            e.setOptions = function(e) {
                u = {};
                for (var t in a) u[t] = e.hasOwnProperty(t) ? e[t] : a[t];
                return this;
            }, e.setImage = function(e) {
                return n = e, w(), this;
            }, e.setBubble = function(e, t) {
                return isNaN(parseFloat(e)) || !isFinite(e) ? m("Bubble must be a number") : (g(e, t), this);
            }, e.reset = function() {
                e.setImage(r);
            }, e.setOptions(a), t.exports = e;
        })();
    }), require.define("/lib/client/js/client.js", function(e, t, n, r, i, s) {
        (function() {
            var t, n, r, i, s, o, u, a, f, l, c, h, p, d, v, m, g, y, b, w, E, S, x = {}.hasOwnProperty, T = function(e, t) {
                function r() {
                    this.constructor = e;
                }
            ...
            c = function() {
                function e() {}
                return e.prototype.add_class = function(e) {
                    return this.node.className += " " + e;
                }, e.prototype.remove_class = function(e) {
                    return this.node.className = this.node.className.split(e).join("");
                }, e.prototype.has_class = function(e) {
                    return this.node.className.indexOf(e) !== -1;
                }, e.prototype.toggle_class = function(e) {
                    return this.has_class(e) ? this.remove_class(e) : this.add_class(e);
                }, e;
            }(), w = e("signals"), a = function(e) {
                function t(e, n) {
                    this.url = t.html_decode(e), this.message = n;
                }
                return T(t, e), t.prototype.has_zoomer = !0, t.prototype.build = function() {
                    var e;
                    return this.node = document.createElement("div"), this.node.className = "media", this.message.content_node.appendChild(this.node), this.message.set_media(this), e = this.build_media(), this.node.appendChild(e), this.has_zoomer && this.build_zoomer(), t.item_loaded.dispatch(this), this.node;
                }, t.prototype.build_zoomer = function() {
                    var e = this;
                    return this.zoomer = document.createElement("button"), this.zoomer.className = "zoomer", this.zoomer.innerHTML = "+", this.node.appendChild(this.zoomer), this.zoomer.addEventListener("click", function() {
                        return e.has_class("zoomed") ? e.unzoom() : e.zoom(), e.toggle_class("zoomed");
                    });
                }, t.types = [], t.add_type = function(e) {
                    return this.types.push(e);
                }, t.match = function(e) {
                    var t, n, r, i, s;
                    e = this.html_decode(e), i = this.types, s = [];
                    for (n = 0, r = i.length; n < r; n++) t = i[n], t.is_match(e) && s.push(t);
                    return s;
                }, t.build = function(e, t) {
                    var n, r;
                    return r = this.match(e), r.length === 0 ? null : (n = r[0], n = new n(e, t), n.start());
                }, t.item_loaded = new w.Signal, t.decode_node = document.createElement("div"), t.html_decode = function(e) {
                    return this.decode_node.innerHTML = e, this.decode_node.innerHTML;
                }, t;
            }(c), n = function(e) {
                function t() {
                    return t.__super__.constructor.apply(this, arguments);
                }
                return T(t, e), t.prototype.has_zoomer = !1, t.prototype.start = function() {
                    return this.build();
                }, t.prototype.build_media = function() {
                    return this.node.className += " audio", this.player = new r(this.url), this.node.appendChild(this.player.node), this.player.node;
                }, t.is_match = function(e) {
                    return !!e.match(/\/[^\/]+\.(mp3|aac|wav|mp2|ogg)(\?.*)?$/i);
                }, t;
            }(a), b = e("jsonp"), i = function(e) {
                function t() {
                    return t.__super__.constructor.apply(this, arguments);
                }
                return T(t, e), t.prototype.key = "5a26fc5f9b7545aaae79a11b6dce7d88", t.prototype.endpoint = "http://api.embed.ly/1/preview", t.prototype.maxwidth = "300", t.prototype.maxheight = "150", t.prototype.has_zoomer = !1, t.prototype.start = function() {
                    return this.build();
                }, t.prototype.build_media = function() {
                    var e = this;
                    return this.node.className += " embedly", this.div = document.createElement("div"), this.perform_request(function(t) {
                        return e.handle_type(e.div, t);
                    }), this.div;
                }, t.prototype.build_url = function() {
                    return "" + this.endpoint + "?key=" + this.key + "&url=" + encodeURIComponent(this.url) + ("&maxwidth=" + this.maxwidth + "&maxheight=" + this.maxheight);
                }, t.prototype.perform_request = function(e) {
                    var t = this;
                    return b(this.build_url(), {}, function(t, n) {
                        return e(n);
                    });
                }, t.prototype.handle_type = function(e, t) {
                    var n, r, i, s, o;
                    return t.object && (t.object.html ? e.innerHTML = t.object.html : t.object.type === "photo" ? (r = this.build_thumb(t), i = document.createElement("a"), i.href = this.url, i.target = "_blank", i.appendChild(r), e.appendChild(i)) : t.type === "html" && (t.images && (s = this.build_thumb(t), s.className = "thumbnail", e.appendChild(s)), o = document.createElement("span"), o.className = "title", o.innerHTML = t.title, n = document.createElement("span"), n.className = "description", n.innerHTML = t.description, e.appendChild(o), e.appendChild(n))), a.item_loaded.dispatch(this);
                }, t.prototype.build_thumb = function(e) {
                    var t, n, r, i, s;
                    return r = e.images[0], t = r.height / r.width, r.height > this.maxheight ? (n = this.maxheight, s = this.maxheight / t) : r.width > this.maxwidth ? (s = this.maxwidth, n = this.maxwidth * t) : (s = r.width, n = r.height), i = document.createElement("img"), i.src = r.url, i.width = s, i.height = n, i.alt = e.title, i.title = e.title, i;
                }, t.prototype.zoom = function() {}, t.prototype.unzoom = function() {}, t.is_match = function(e) {
                    return !0;
                }, t;
            }(a), a.add_type(i), u = function(e) {
                function t() {
                    return t.__super__.constructor.apply(this, arguments);
                }
                return T(t, e), t.prototype.start = function() {
                    var e = this;
                    return this.img = new Image, this.img.src = this.url, this.img.loaded ? this.build() : this.img.addEventListener("load", function() {
                        return e.build();
                    });
                }, t.prototype.build_media = function() {
                    var e = this;
                    return this.original_width = this.img.width, this.node.className += " image", this.link_node = document.createElement("a"), this.link_node.href = this.url, this.link_node.target = "_blank", this.link_node.appendChild(this.img), setTimeout(function() {
                        var t;
                        return t = window.getComputedStyle(e.img), e.small_width = parseInt(t.width), e.unzoom();
                    }, 1), this.link_node;
                }, t.prototype.zoom = function() {
                    return this.zoomer.style.left = "auto", this.zoomer.style.right = "0";
                }, t.prototype.unzoom = function() {
                    var e;
                    return e = this.small_width > 20 ? this.small_width : 20, this.zoomer.style.left = this.small_width - 20 + "px", this.zoomer.style.right = "auto";
                }, t.is_match = function(e) {
                    return !!e.match(/\/[^\/]+\.(png|jpg|jpeg|gif)(\?.*)?$/i);
                }, t;
            }(a), y = e("dlite-jsonp"), h = function(e) {
                function t() {
                    return t.__super__.constructor.apply(this, arguments);
                }
                return T(t, e), t.regex = /https?:\/\/\w{0,3}.?twitter+\.\w{2,3}\/.+\/status\/(\d{18})/, t.prototype.has_zoomer = !1, t.prototype.start = function() {
                    return this.build();
                }, t.prototype.build_media = function() {
                    var e, n = this;
                    return this.node.className += " twitter not_zoomable", e = this.url.match(t.regex), this.container = document.createElement("div"), e ? (this.tweet_id = e[1], y("//api.twitter.com/1/statuses/oembed.json?id=" + this.tweet_id + "&include_entities=true&omit_script=true&callback=%3F", function(e) {
                        return n.container.innerHTML = e.html, a.item_loaded.dispatch(n);
                ...
                return T(t, e), t.regex = /https?:\/\/\w{0,3}.?vimeo+\.\w{2,3}\/(\d{5,15})(.*)?/, t.prototype.start = function() {
                    return this.build();
                }, t.prototype.build_media = function() {
                    var e;
                    return this.node.className += " vimeo", e = this.url.match(t.regex), this.iframe = document.createElement("iframe"), e ? (this.video_id = e[1], this.iframe.type = "text/html", this.iframe.src = "http://player.vimeo.com/video/" + this.video_id, this.iframe) : this.iframe;
                }, t.prototype.zoom = function() {}, t.prototype.unzoom = function() {}, t.is_match = function(e) {
                    return !!e.match(this.regex);
                }, t;
            }(a), v = function(e) {
                ...
                return T(t, e), t.regex = /https?:\/\/\w{0,3}.?youtube+\.\w{2,3}\/watch\?.*v=([\w-]{11})(\&.*)?/, t.prototype.start = function() {
                    return this.build();
                }, t.prototype.build_media = function() {
                    var e;
                    return this.node.className += " youtube", e = this.url.match(t.regex), this.iframe = document.createElement("iframe"), e ? (this.video_id = e[1], this.iframe.type = "text/html", this.iframe.src = "http://www.youtube.com/embed/" + this.video_id + "?wmode=opaque", this.iframe) : this.iframe;
                }, t.prototype.zoom = function() {}, t.prototype.unzoom = function() {}, t.is_match = function(e) {
                    return !!e.match(this.regex);
                }, t;
            }(a), E = e("store"), g = e("socket.io-client"), t = function() {
                function e() {
                    var e = this;
                    this.node = document.body, this.socket = g.connect(), this.socket.on("connect", function() {
                        if (!e.started) return e.started = !0, e.start();
                    });
                }
                return e.prototype.start = function() {
                    var e = this;
                    return this.message_list = new l(this.socket, this.get_options()), this.entry_form = new s(this.socket, this.get_options().name), this.socket.emit("create_session", this.get_options(), function(t) {
                        return e.set_option("token", t.token), e.set_option("color", t.color), e.build(), e.attach_signals();
                    });
                }, e.prototype.build = function() {
                    return this.node.appendChild(this.message_list.node), this.node.appendChild(this.entry_form.node), this.focus(), this.entry_form.set_color(this.get_options().color), this.entry_form.set_token(this.get_options().token);
                }, e.prototype.attach_signals = function() {
                    var e = this;
                    return this.entry_form.message_submitted.add(function(t, n) {
                        var r;
                        return r = f.build(t, e.get_options(), e.socket, n), r.send();
                    }), this.entry_form.name_changed.add(function(t) {
                        return e.set_option("name", t);
                    });
                ...
                }, e.prototype.set_option = function(e, t) {
                    return E.set(e, t), this.get_options()[e] = t;
                }, e.start = function() {
                    return m.app = new e;
                }, e;
            }(), m = window, window.addEventListener ? addEventListener("DOMContentLoaded", t.start) : attachEvent("onload", t.start), w = e("signals"), o = function() {
                function e() {
                    this.build(), this.attach_events(), this.filters = {};
                }
                return e.prototype.build = function() {
                    var e, t, n, r, i, s, o, u, a, f;
                    return this.node = document.createElement("div"), this.node.id = "filter_pane", e = document.createElement("fieldset"), this.node.appendChild(e), u = document.createElement("legend"), u.innerHTML = "Filters", e.appendChild(u), s = document.createElement("div"), s.className = "field keyword", e.appendChild(s), o = document.createElement("label"), o.innerHTML = "Keyword", o["for"] = "keyword", s.appendChild(o), this.keyword = document.createElement("input"), this.keyword.id = "keyword", this.keyword.type = "text", s.appendChild(this.keyword), r = document.createElement("div"), r.className = "field show_joinpart", e.appendChild(r), i = document.createElement("label"), i.innerHTML = "Show join / part messages", i["for"] = "show_joinpart", r.appendChild(i), this.show_joinpart = document.createElement("input"), this.show_joinpart.id = "show_joinpart", this.show_joinpart.value = !0, this.show_joinpart.checked = !1, this.show_joinpart.type = "checkbox", r.appendChild(this.show_joinpart), a = document.createElement("div"), a.className = "field mediaonly", e.appendChild(a), f = document.createElement("label"), f.innerHTML = "With Media Only", f["for"] = "mediaonly", a.appendChild(f), this.mediaonly = document.createElement("input"), this.mediaonly.id = "mediaonly", this.mediaonly.value = !0, this.mediaonly.checked = !1, this.mediaonly.type = "checkbox", a.appendChild(this.mediaonly), t = document.createElement("div"), t.className = "field hidemedia", e.appendChild(t), n = document.createElement("label"), n.innerHTML = "Hide Media", n["for"] = "hidemedia", t.appendChild(n), this.hidemedia = document.createElement("input"), this.hidemedia.id = "hidemedia", this.hidemedia.value = !0, this.hidemedia.checked = !1, this.hidemedia.type = "checkbox", t.appendChild(this.hidemedia);
                }, e.prototype.attach_events = function() {
                    var e = this;
                    return this.show_joinpart.addEventListener("change", function() {
                        return e.set_option("show_joinpart", e.show_joinpart.checked);
                    }), this.keyword.addEventListener("change", function() {
                        var t;
                        return t = e.keyword.value.split(/\s+/), t[0] === "" && (t = []), e.set_option("keywords", t);
                    }), this.mediaonly.addEventListener("change", function() {
                        return e.set_option("mediaonly", e.mediaonly.checked);
                    }), this.hidemedia.addEventListener("change", function() {
                        return e.set_option("hidemedia", e.hidemedia.checked);
                    });
                }, e.prototype.change = function() {
                    return this.changed.dispatch(this.get_filters());
                }, e.prototype.get_filters = function() {
                    return this.filters;
                }, e.prototype.set_option = function(e, t) {
                    return this.filters[e] = t, this.change();
                }, e.prototype.changed = new w.Signal, e;
            }(), w = e("signals"), p = function() {
                function e(e, t) {
                    this.socket = t, this.drop_target = e, this.build(), this.attach_events(), this.windowUrl = window.URL || window.webkitURL;
                }
                return e.prototype.build = function() {
                    return this.node = document.createElement("div"), this.node.className = "uploader", this.name_node = document.createElement("p"), this.name_node.className = "name", this.size_node = document.createElement("p"), this.size_node.className = "size", this.preview_icon = new Image, this.preview_icon.className = "preview_icon", this.node.appendChild(this.preview_icon), this.cancel_btn = document.createElement("button"), this.cancel_btn.innerHTML = "X", this.file_input = document.createElement("input"), this.file_input.type = "file", this.file_input.accept = "image/*,audio/*", this.file_input.multiple = "", this.select_button = document.createElement("div"), this.select_button.id = "upload_select_button", this.select_button_node = document.createElement("button"), this.select_button_node.innerHTML = "...", this.select_button.appendChild(this.file_input), this.select_button.appendChild(this.select_button_node), this.select_button.className = "select_file section", this.progress_bar = document.createElement("progress"), this.progress_bar.setAttribute("min", 0), this.progress_bar.setAttribute("max", 100), this.progress_bar.setAttribute("value", 0), this.progress_bar.className = "upload_progress_bar", this.node.appendChild(this.cancel_btn), this.node.appendChild(this.name_node), this.node.appendChild(this.size_node);
                }, e.prototype.attach_events = function() {
                    var e = this;
                    return this.drop_target.addEventListener("dragenter", function(e) {
                        return e.preventDefault(), e.stopPropagation();
                    }), this.drop_target.addEventListener("dragover", function(e) {
                        return e.preventDefault(), e.stopPropagation();
                    }), this.drop_target.addEventListener("drop", function(t) {
                        var n, r, i, s;
                        t.preventDefault(), t.stopPropagation(), n = t.dataTransfer, i = n.files, r = i[0];
                        if (r) return e.set_selected_file(r);
                        if ((s = n.getData("text/uri-list")) && typeof s == "string") return e.add_selected_uri(s);
                    }), this.cancel_btn.addEventListener("click", function(t) {
                        return e.clear();
                    }), this.select_button_node.addEventListener("click", function(t) {
                        return e.file_input.click();
                    }), this.file_input.addEventListener("change", function(t) {
                        var n;
                        return n = e.file_input.files[0], n ? e.set_selected_file(n) : !1;
                    });
                }, e.prototype.valid_file = function(e) {
                    return e && e.type.match(/^(image)|(audio)\//);
                }, e.prototype.set_selected_file = function(e) {
                    return this.valid_file(e) ? (this.windowUrl && (this.preview_icon.src = this.windowUrl.createObjectURL(e)), this.selected_file = e, this.file_selected.dispatch(e), this.name_node.innerHTML = e.name, this.size_node.innerHTML = (e.size / 1024).toFixed(2) + "KB") : !1;
                }, e.prototype.add_selected_uri = function(e) {
                    return this.uri_added.dispatch(e);
                }, e.prototype.set_token = function(e) {
                    return this.token = e;
                }, e.prototype.start = function() {
                    return this.progress_bar.style.display = "block", this.started.dispatch();
                }, e.prototype.clear = function() {
                    return this.selected_file = null, this.progress_bar.value = 0, this.progress_bar.style.display = "none", this.cleared.dispatch();
                }, e.prototype.stop = function() {
                    return this.progress_bar.value = 0, this.progress_bar.style.display = "none", this.stopped.dispatch();
                }, e.prototype.upload = function() {
                    var e, t, n = this;
                    return this.selected_file ? (e = new FormData, e.append("image", this.selected_file), t = new XMLHttpRequest, t.onreadystatechange = function(e) {
                        var r;
                        if (t.readyState >= 3 && t.status && t.status >= 400) return r = JSON.parse(t.responseText), n.error.dispatch(r), n.stop();
                    }, t.upload.addEventListener("progress", function(e) {
                        var t;
                        return t = e.loaded / e.totalSize * 100, console.log(e, t), t === 100 ? n.progress_bar.removeAttribute("value") : n.progress_bar.setAttribute("value", t);
                    }), t.addEventListener("load", function(e) {
                        var r;
                        n.progress_bar.removeAttribute("value");
                        if (t.status === 200) return r = JSON.parse(t.responseText), n.completed.dispatch(r.path), n.clear();
                        if (t.status <= 400 || t.status < 200) return r = JSON.parse(t.responseText), n.error.dispatch(r), n.stop();
                    }), t.addEventListener("error", function(e) {
                        return console.log("error", e);
                    }), t.addEventListener("abort", function(e) {
                        return console.log("abort", e);
                    }), t.open("POST", "/upload"), t.setRequestHeader("X-Upload-Length", this.selected_file.size), t.setRequestHeader("X-Token", this.token), t.send(e), this.start()) : !1;
                }, e.prototype.file_selected = new w.Signal, e.prototype.uri_added = new w.Signal, e.prototype.cleared = new w.Signal, e.prototype.started = new w.Signal, e.prototype.stopped = new w.Signal, e.prototype.progress = new w.Signal, e.prototype.completed = new w.Signal, e.prototype.error = new w.Signal, e.supported = function() {
                    return XMLHttpRequest ? typeof FileList != "undefined" && FileList !== null && typeof FormData != "undefined" && FormData !== null && (new XMLHttpRequest).upload != null : !1;
                }, e;
            }(), w = e("signals"), s = function() {
                function e(e, t) {
                    this.name = t || "Anonymous", this.socket = e, this.build(), this.attach_events();
                }
                return e.prototype.build = function() {
                    var e = this;
                    return this.node = document.createElement("div"), this.node.id = "entry_form", this.name_section = document.createElement("div"), this.name_section.className = "name section", this.node.appendChild(this.name_section), this.name_input = document.createElement("input"), this.name_input.type = "text", this.name_input.value = this.name, this.name_section.appendChild(this.name_input), this.message_section = document.createElement("div"), this.message_section.className = "message section", this.node.appendChild(this.message_section), this.message_input = document.createElement("textarea"), this.message_section.appendChild(this.message_input), this.send_section = document.createElement("div"), this.send_section.className = "send section", this.node.appendChild(this.send_section), this.send_button = document.createElement("button"), this.send_button.innerHTML = "Send", this.send_section.appendChild(this.send_button), p.supported() && (this.upload_section = document.createElement("div"), this.upload_section.className = "upload section", this.uploader = new p(document.body, this.socket), this.upload_section.appendChild(this.uploader.node), this.uploader.uri_added.add(function(t) {
                        return e.message_input.value += t;
                    }), this.message_section.appendChild(this.uploader.progress_bar), this.node.insertBefore(this.upload_section, this.message_section), this.select_file_section = this.uploader.select_button, this.node.insertBefore(this.select_file_section, this.send_section)), this.node;
                }, e.prototype.attach_events = function() {
                    var e = this;
                    this.message_input.addEventListener("keypress", function(t) {
                        return t.keyCode !== 13 || t.shiftKey ? null : (t.preventDefault(), e.submit_message());
                    }), this.send_button.addEventListener("click", function() {
                        return e.submit_message();
                    }), this.name_input.addEventListener("keypress", function(t) {
                        return t.keyCode === 13 ? e.focus() : setTimeout(function() {
                            return e.change_name();
                        }, 1);
                    }), this.name_input.addEventListener("change", function(t) {
                        return e.change_name();
                    });
                    if (this.uploader) return this.uploader.file_selected.add(function(t) {
                        return e.upload_section.className += " selected";
                    }), this.uploader.cleared.add(function() {
                        return e.upload_section.className = e.upload_section.className.split("selected").join("");
                        ...
                        return e.enable();
                    }), this.uploader.error.add(function() {
                        return e.enable();
                    });
                }, e.prototype.disable = function() {
                    return this.disabled = !0, this.message_input.setAttribute("disabled", "disabled"), this.send_button.setAttribute("disabled", "disabled");
                }, e.prototype.enable = function() {
                    return this.disabled = !1, this.message_input.removeAttribute("disabled"), this.send_button.removeAttribute("disabled");
                }, e.prototype.set_color = function(e) {
                    return this.color = e, this.name_input.style.backgroundColor = "rgb(" + e[0] + ", " + e[1] + ", " + e[2] + ")";
                }, e.prototype.set_token = function(e) {
                    this.token = e;
                    if (this.uploader) return this.uploader.set_token(e);
                }, e.prototype.focus = function() {
                    return this.message_input.focus();
                }, e.prototype.submit_message = function() {
                    var e, t, n, r, i, s = this;
                    if (this.disabled) return null;
                    r = this.message_input.value, n = this.uploader && this.uploader.selected_file, i = !!r.match(/[^\s]/);
                    if (n) return this.uploader.upload(), e = function(n) {
                        return s.uploader.completed.remove(e), s.uploader.error.remove(t), s.perform_submit({
                            image: n
                        });
                    }, t = function() {
                        return s.uploader.completed.remove(e), s.uploader.error.remove(t);
                    }, this.uploader.completed.add(e), this.uploader.error.add(t);
                    if (i) return this.perform_submit();
                }, e.prototype.perform_submit = function(e) {
                    return this.message_submitted.dispatch(this.message_input.value, e), this.message_input.value = "", this.focus();
                }, e.prototype.change_name = function() {
                    var e, t;
                    e = this.name_input.value, t = !!e.match(/[^\s]/);
                    if (t) return this.name_changed.dispatch(this.name_input.value);
                }, e.prototype.message_submitted = new w.Signal, e.prototype.name_changed = new w.Signal, e;
            }(), r = function() {
                function e(e) {
                    this.set_src(e), this.build();
                }
                return e.prototype.src = null, e.prototype.node = null, e.prototype.play_btn = null, e.prototype.sound = null, e.sound_counter = 0, e.prototype.set_src = function(e) {
                    this.src = e;
                    if (e) return this.build_sound();
                }, e.prototype.build = function() {
                    var e = this;
                    return this.node = document.createElement("div"), this.node.className = "audio_player stop", this.play_btn = document.createElement("button"), this.play_btn.innerHTML = "play", this.play_btn.className = "play_btn", this.node.appendChild(this.play_btn), this.play_btn.addEventListener("click", function() {
                        return e.play();
                    }), this.stop_btn = document.createElement("button"), this.stop_btn.innerHTML = "stop", this.stop_btn.className = "stop_btn", this.node.appendChild(this.stop_btn), this.stop_btn.addEventListener("click", function() {
                        return e.stop();
                    }), this.progress_bar = document.createElement("progress"), this.progress_bar.setAttribute("max", 1), this.progress_bar.setAttribute("value", 0), this.node.appendChild(this.progress_bar), this.node;
                }, e.prototype.build_sound = function() {
                    var t = this;
                    return soundManager.enabled ? this.sound = soundManager.createSound({
                        id: "sound-" + e.sound_counter++,
                        url: this.src,
                        ...
                        return t.build_sound();
                    });
                }, e.prototype.play = function() {
                    if (this.sound) return this.sound.play();
                }, e.prototype.stop = function() {
                    return this.sound && this.sound.stop(), this.progress_bar.setAttribute("value", 0);
                }, e.prototype.progress = function() {
                    return this.progress_bar.setAttribute("max", this.sound.durationEstimate), this.progress_bar.setAttribute("value", this.sound.position);
                }, e;
            }(), S = e("tinycon/tinycon"), l = function(e) {
                function t(e, t) {
                    this.filters_set = N(this.filters_set, this), this.socket = e, this.options = t, this.messages = [], this.messages_while_away = 0, this.window_focused = !0, this.filter_pane = new o, this.build(), this.attach_events();
                }
                return T(t, e), t.prototype.window_focused = null, t.prototype.build = function() {
                    var e;
                    return this.node = document.createElement("div"), this.node.id = "message_list", this.scroll_node = document.createElement("div"), this.scroll_node.className = "scroller", this.list_node = document.createElement("ul"), this.list_node.className = "messages", this.scroll_node.appendChild(this.list_node), this.node.appendChild(this.scroll_node), this.node.appendChild(this.filter_pane.node), this.resize(), this.lost_connection_node = document.createElement("li"), this.lost_connection_node.className = "lost_connection", this.lost_connection_node.appendChild(document.createElement("div")), e = document.createElement("div"), this.lost_connection_node.appendChild(e), e.innerHTML = "Your connection was lost.", this.remember_line = document.createElement("div"), this.remember_line.className = "remember_line", this.remember_line.appendChild(document.createElement("div")), this.remember_line.appendChild(document.createElement("div")), this.remember_line.appendChild(document.createElement("div")), this.socket.emit("get_messages"), this.node;
                }, t.prototype.attach_events = function() {
                    var e = this;
                    return this.socket.on("messages", function(t) {
                        var n, r, i, s;
                        s = t.reverse();
                        for (r = 0, i = s.length; r < i; r++) n = s[r], e.add_message(n);
                        return e.messages_added(t);
                    }), this.socket.on("connect", function() {
                        if (e.lost_connection_node.parentNode) return e.list_node.removeChild(e.lost_connection_node);
                    }), this.socket.on("disconnect", function() {
                        return e.list_node.appendChild(e.lost_connection_node), e.scroll_bottom();
                    }), window.addEventListener("resize", function() {
                        return e.resize();
                    }), a.item_loaded.add(function() {
                        return e.scroll_bottom();
                    }), this.filter_pane.changed.add(this.filters_set), this.is_hidden() && this.place_remember_line(), this.on_visibility_changed(function(t) {
                        return e.is_hidden(t) ? e.blurred() : e.focused();
                    });
                }, t.prototype.place_remember_line = function() {
                    return this.list_node.appendChild(this.remember_line), this.scroll_bottom;
                }, t.prototype.check_remember_line = function() {
                    var e, t;
                    if (!this.remember_line.parentNode) return null;
                    t = this.remember_line;
                    while (t = t.nextSibling) {
                        e = window.getComputedStyle(t);
                        if (e.display !== "none") return null;
                    }
                    return this.list_node.removeChild(this.remember_line);
                }, t.prototype.is_hidden = function(e) {
                    return e && e.type === "blur" ? this.window_focused = !1 : e && e.type === "focus" ? this.window_focused = !0 : this.visibility_support() && (this.window_focused = !document[this.visibility_support()]), !this.window_focused;
                }, t.prototype.visibility_support = function() {
                    var e, t, n, r;
                    t = "hidden msHidden mozHidden webkitHidden".split(" ");
                    for (n = 0, r = t.length; n < r; n++) {
                        e = t[n];
                        if (document[e] !== void 0) return e;
                    }
                }, t.prototype.on_visibility_changed = function(e) {
                    var t, n, r;
                    return r = this.visibility_support(), n = {
                        hidden: "visibilitychange",
                        msHidden: "msvisibilitychange",
                        mozHidden: "mozvisibilitychange",
                        webkitHidden: "webkitvisibilitychange"
                    }, t = n[r], t ? document.addEventListener(t, e) : (window.addEventListener("focus", function() {
                        var t;
                ...
                }, t.prototype.add_message = function(e) {
                    return e.user_name = this.options.name, e = new f(e), this.messages[this.messages.length] = e, this.list_node.appendChild(e.build()), e.filter(this.filter_pane.get_filters()), this.scroll_bottom();
                }, t.prototype.messages_added = function(e) {
                    if (this.is_hidden()) return this.messages_while_away += e.length, S.setBubble(this.messages_while_away);
                }, t.prototype.focused = function() {
                    return this.messages_while_away = 0, S.setBubble(0), this.check_remember_line();
                }, t.prototype.blurred = function() {
                    return this.place_remember_line();
                }, t.prototype.resize = function() {
                    return this.node.style.height = window.innerHeight - 40 + "px", this.scroll_bottom();
                }, t.prototype.scroll_bottom = function() {
                    return this.scroll_node.scrollTop = this.list_node.scrollHeight;
                }, t.prototype.filters_set = function(e) {
                    var t = this;
                    return setTimeout(function() {
                        var n, r, i, s;
                        e.show_joinpart ? t.add_class("show_joinpart") : t.remove_class("show_joinpart"), e.mediaonly ? t.add_class("mediaonly") : t.remove_class("mediaonly"), e.hidemedia ? t.add_class("hidemedia") : t.remove_class("hidemedia"), s = t.messages;
                        for (r = 0, i = s.length; r < i; r++) n = s[r], n.filter(e);
                        return t.scroll_bottom();
                    }, 1);
                }, t;
            }(c), f = function(e) {
                function t(e, t) {
                    return this.id = e.id, this.content = e.content, this.author_name = e.author_name, this.color = e.color, this.user_name = e.user_name, this.image = e.image, this.server_event = e.server_event, this.sent_at = e.sent_at ? new Date(e.sent_at) : new Date, this.socket = t, this.media = null, this.user_name != null && (this.reference_regex = new RegExp("@(" + this.user_name + ")")), this.reference = !1, this;
                }
                return T(t, e), t.prototype.url_regex = /(http|ftp|https):\/\/[\w\-_]+(\.[\w\-_]+)+([\w\-\.\(\),@?^=%&amp;:\/~\+#\!]*[\w\-\@?^=%&amp;\/~\+#\!])?/g, t.prototype.reference_regex = /\@(\w+)/, t.stripper_node = null, t.prototype.attributes = function() {
                    return {
                        id: this.id,
                    ...
                    return this.socket.emit("message", this.attributes()), this;
                }, t.prototype.build_content = function() {
                    var e, t;
                    t = this.content.match(this.url_regex), e = this.handle_reference(this.content), t ? (e = this.content.replace(this.url_regex, "<a href='$&' target='_blank'>$&</a>", "g"), this.content_node.innerHTML = e) : this.content_node.innerHTML = this.content;
                    if (this.image) return a.build(this.strip_html(this.image), this);
                    if (t) return a.build(this.strip_html(t[0]), this);
                }, t.prototype.strip_html = function(e) {
                    return this.stripper_node || (this.stripper_node = document.createElement("div"), this.stripper_node.style.display = "none"), this.stripper_node.innerHTML = e, this.stripper_node.innerText;
                }, t.prototype.build = function() {
                    var e;
                    return this.node = document.createElement("li"), this.node.className = "message", this.author_node = document.createElement("p"), this.author_node.className = "author", this.author_node.innerHTML = this.author_name, this.color != null && (e = "rgb(" + this.color[0] + ", " + this.color[1] + ", " + this.color[2] + ")", this.author_node.style.backgroundColor = e), this.node.appendChild(this.author_node), this.content_node = document.createElement("div"), this.content_node.className = "content", this.node.appendChild(this.content_node), this.build_content(), this.time_node = document.createElement("div"), this.time_node.className = "time", this.time_wrapper = document.createElement("span"), this.time_wrapper.className = "time_wrapper", this.time_wrapper.appendChild(this.time_node), this.node.appendChild(this.time_wrapper), this.sent_at && (this.time_node.innerHTML = this.format_date(this.sent_at)), this.is_joinpart() && (this.node.className += " joinpart"), this.reference && (this.node.className += " reference"), this.node;
                }, t.prototype.format_date = function(e) {
                    return e = (new Date(Date.parse(e.toString()))).toLocaleTimeString();
                }, t.prototype.is_filtered = function() {
                    return this.node.style.display !== "none";
                }, t.prototype.set_media = function(e) {
                    this.media = e;
                    if (this.has_media()) return this.node.className += " media";
                }, t.prototype.handle_reference = function(e) {
                    return this.user_name == null ? e : (e.match(this.reference_regex) && (this.reference = !0), e);
                }, t.prototype.hide = function() {
                    return this.add_class("filtered");
                }, t.prototype.show = function() {
                    return this.remove_class("filtered");
                }, t.prototype.is_joinpart = function() {
                    return this.server_event;
                }, t.prototype.has_media = function() {
                    return !!this.media;
                    ...
                    if (e.keywords) {
                        ...
                        for (n = 0, r = i.length; n < r; n++) {
                            t = i[n];
                            if (this.content.indexOf(t) === -1) return this.hide();
                        }
                    }
                    return this.show();
                }, t.build = function(e, n, r, i) {
                    var s;
                    return s = i && i.image ? i.image : null, new t({
                        content: e,
                        author_name: n.name,
                        color: n.color,
                        image: s
